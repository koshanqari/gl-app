        ...
        <div className="flex items-center justify-between px-6 py-4">
          <div className="flex items-center gap-4">
            <Button
              variant="outline"
              size="icon"
              onClick={() => router.push(`/executive/partners/${partner.id}/events`)}
      ...
      <div className="flex">
        ...
        <aside className="w-64 bg-white border-r border-slate-200 min-h-[calc(100vh-73px)] p-4">
          <nav className="space-y-2">
            ...
            <Link
              href={`/executive/events/${eventId}/registrations`}
              className={`w-full flex items-center justify-start px-4 py-2 text-sm font-medium rounded-md transition-colors ${
                pathname === `/executive/events/${eventId}/registrations`
                  ? "bg-primary text-primary-foreground"
                  : "text-slate-700 hover:bg-slate-100"
              }`}
            >
            ...
            <Link
              href={`/executive/events/${eventId}/venue`}
              className={`w-full flex items-center justify-start px-4 py-2 text-sm font-medium rounded-md transition-colors ${
                pathname === `/executive/events/${eventId}/venue`
                  ? "bg-primary text-primary-foreground"
                  : "text-slate-700 hover:bg-slate-100"
              }`}
            >
            ...
            <Link
              href={`/executive/events/${eventId}/itinerary`}
              className={`w-full flex items-center justify-start px-4 py-2 text-sm font-medium rounded-md transition-colors ${
                pathname === `/executive/events/${eventId}/itinerary`
                  ? "bg-primary text-primary-foreground"
                  : "text-slate-700 hover:bg-slate-100"
              }`}
            >
